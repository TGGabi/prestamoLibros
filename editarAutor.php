    ...
    <section class="contenido">
        <div class="container p-2 text-center d-grid gap-2 d-md-block col-6">
            ...
            <?php
                ...
                ?>
                    <form action="editAut.php" method="post" class="mb-3" required>
                        <div class="mb-3">
                            <label for="txtId" class="form-label">ID</label>    
                            <input type="number" name="txtId" id="txtId" readonly value="<?php echo $row['idautores'] ?>" class="form-control" required>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <input type="text" name="txtLugar" id="txtLugar" value="<?php echo $row['lugarNacimiento'] ?>" class="form-control" required>
                        </div>
                        <div class="row mb-3">
                            <label for="dtFechaNac" class="form-label">Fecha de nacimiento</label>
                            <input type="date" name="dtFechaNac" id="dtFechaNac" value="<?php echo $row['fechaNacimiento'] ?>" class="form-control" required>
                        </div>
                        <div class="row mb-3">
                            <label for="txtBiografia" class="form-label">Link a biografía</label>
                            <input type="text" name="txtBiografia" id="txtBiografia" value="<?php echo $row['linkBiografia'] ?>" class="form-control" required>
                        </div>
